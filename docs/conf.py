# -*- coding: utf-8 -*-
#
# pytest-tolerance documentation build configuration file, created by
...
project = u'pytest-tolerance'
copyright = u'2019, Juan Luis Cano Rodríguez'
author = u'Juan Luis Cano Rodríguez'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-tolerance Documentation',
     [author], 1)
]
